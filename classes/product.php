...
<?php 
	...
	*/
	class product
	{
		...
		public function getLastestThinkPad()
		{
		...
		public function getLastestThinkPad2()
		{
			$query = "SELECT * FROM tbl_product where brandId = '17' order by productId desc limit 4";
			$result = $this->db->select($query);
			return $result;	
		}
		public function getLastestMSI2()
		{
			$query = "SELECT * FROM tbl_product where brandId = '18' order by productId desc limit 4";
			$result = $this->db->select($query);
			return $result;	
		}


		public function showProductOnePage()
		{
			$productPage = 4;
			if(!isset($_GET['page']))
			{
			...
			$onePage = ($page-1)*$productPage;

			$query ="SELECT * FROM tbl_product  order by productId desc limit $onePage,$productPage";
			$result = $this->db->select($query);
			return $result;
